  ...
  const doc = buildDocument([
    ...
    table(
      ...
      [
        ...
        ["56", "The exercise count cited throughout this document (1,218) describes the original imported spreadsheet and the epics that ran against it at the time — those historical entries are accurate for when they were written and are not being retroactively rewritten. The live database has grown past that: select count(*) from source_exercises returned 1,271 as of a 2026-09-01 QA-audit pass. This document does not track how those ~53 additional rows arrived; worth a dedicated look if the discrepancy matters for a future data-integrity decision.", "Open"],
